...
// The three shapes a content block can be, spelled the way the CHECK in
// schema.sql spells them. They are the schema's own words rather than the
// core's, which is why they live here and not in messages.
const (
	kindText   = "text"
	kindUse    = "use"
	kindResult = "result"
